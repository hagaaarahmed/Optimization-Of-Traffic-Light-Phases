...
def run(i):
	...
	while steps < endSimTIme:
		...
		'''
                output.write("Step:"),output.write(str(steps))
                output.write ("\n")
                output.write ("3 phases: ")  ,output.write(str(PSOphase))
                output.write ("\n")
       ...
       #print(len(AllPSOphase[-1]))
		...
		junctions for "time" number of simulation steps
		 ...
		 allWaitingTime.append(sum(temp1)/sum(alldeparted))
	      ...
	      output.write("Step:"),output.write(str(steps))
              output.write ("\n") 
              output.write ("3 phases: ")  ,output.write(str(particle))
              output.write ("\n")
              output.write ("Phase Average: ")  ,output.write(str(phase))
              output.write ("\n")
              output.write("Fitness:"), output.write(str(fitness))
...
def penalty(phase):
    phase=abs(phase-random.randint(30,125))
    return phase
...
if __name__ == "__main__":
    ...
    for i in range (10):
        ...
        output.write("\n")
        output.write("Best phases:"), output.write(str(bestphase[-1][0]))
	output.write("\n")
        output.write("Best fitness:"), output.write(str(bestfitness[-1]))
        output.write("\n")
        #print("BestResults: ",BestResults)
    print("Best phases of all iterations: ")
    print(BestResults)
    output.write("all fitness of all populations:"), output.write(str(allFitness))
    output.write("all PSO phases of all populations:"), output.write(str(AllPSOphase))
